...
(function() {
    ...
    const AnimePreview = {
        ...
        open(w) {
            ...
            const googleQuery = encodeURIComponent(`${w.title || ''} アニメ`);
            ...
            content.innerHTML = `
                <div class="flex items-start gap-4 mb-4">
                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        <div class="flex flex-wrap gap-2">
                            <a href="${detailUrl}" class="inline-flex items-center gap-1.5 text-[11px] text-sky-500 font-bold hover:text-sky-600">
                                <i class="fa-solid fa-arrow-right"></i>詳細ページを開く
                            </a>
                            <a href="${googleUrl}" target="_blank" rel="noopener" class="inline-flex items-center gap-1.5 text-[11px] text-slate-500 font-bold hover:text-slate-700">
                ...
                <div class="flex flex-wrap gap-2 mb-4 mt-3" id="animePreviewActions_${w.id}">
