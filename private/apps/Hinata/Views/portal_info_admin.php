...
<body class="flex h-screen overflow-hidden text-slate-800 <?= $bodyBgClass ?? '' ?>"<?= !empty($bodyStyle) ? ' style="' . htmlspecialchars($bodyStyle) . '"' : '' ?>>
    ...
    <main class="flex-1 flex flex-col min-w-0 overflow-y-auto">
        <header class="h-14 bg-white border-b <?= $headerBorder ?? 'border-slate-200' ?> flex items-center justify-between px-4 shrink-0 sticky top-0 z-20 shadow-sm">
            <div class="flex items-center gap-3">
                ...
                <h1 class="font-black text-slate-700 tracking-tight text-lg">ポータル情報管理</h1>
            </div>
