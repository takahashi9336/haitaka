 ...
 * 保存先: www/assets/img/announcements/
 * 返却: { status: 'success', image_url: 'img/announcements/xxx.jpg' } または error
 */
...
$baseDir = dirname(__DIR__, 2) . '/assets/img/announcements/';
if (!is_dir($baseDir)) {
...
$fileName = 'ann_' . date('YmdHis') . '_' . substr(bin2hex(random_bytes(4)), 0, 8) . '.' . $ext;
...
$imageUrl = 'img/announcements/' . $fileName;
