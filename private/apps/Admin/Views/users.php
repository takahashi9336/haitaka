            ...
            <div class="max-w-4xl mx-auto w-full">
                <div class="bg-white p-5 md:p-8 rounded-xl border border-slate-100 shadow-sm">
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
                        ...
                        <button type="button" onclick="document.getElementById('createUserModal').classList.remove('hidden')" class="shrink-0 w-full sm:w-auto bg-indigo-600 hover:bg-indigo-700 text-white text-xs font-black tracking-wider px-6 h-12 rounded-xl shadow-md shadow-indigo-200/50 transition-all flex items-center justify-center gap-2">
                            ...
                            <tbody class="divide-y divide-slate-50">
                                ...
                                <tr class="hover:bg-slate-50/50 transition-colors">
                                    ...
                                    <td class="px-6 py-4 text-right">
                                        <button type="button" onclick="openResetModal(<?= (int)$u['id'] ?>, <?= json_encode($u['id_name'], JSON_HEX_TAG | JSON_HEX_APOS | JSON_HEX_QUOT) ?>)" class="text-[10px] font-black tracking-wider text-indigo-600 bg-indigo-50 hover:bg-indigo-100 px-3 py-1.5 rounded-lg transition-colors">リセット</button>
                                    </td>
                                </tr>
                                <?php endforeach; ?>
                            </tbody>
            ...
            <div class="bg-white rounded-2xl shadow-xl w-full max-w-md p-6 md:p-8">
                ...
                <form id="formReset" class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="password" name="new_password" id="resetNewPassword" required minlength="6" class="w-full border border-slate-200 rounded-xl h-12 px-4 text-sm bg-slate-50 focus:bg-white focus:ring-2 focus:ring-indigo-100 outline-none transition-all" placeholder="6文字以上">
                    </div>
                    <div class="flex gap-3 pt-2">
                        <button type="submit" class="flex-1 bg-indigo-600 hover:bg-indigo-700 text-white text-xs font-black tracking-wider h-12 rounded-xl transition-all">リセットする</button>
