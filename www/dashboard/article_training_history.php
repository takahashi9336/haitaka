    ...
    <main class="flex-1 flex flex-col min-w-0 relative">
        <header class="h-16 bg-white/80 backdrop-blur-md border-b <?= $headerBorder ?> flex items-center justify-between px-6 shrink-0 sticky top-0 z-10">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <h1 class="font-black text-slate-700 text-xl tracking-tighter">記事トレーニング履歴</h1>
                    <p class="text-xs text-slate-400">これまで書いた「ほめポイント／ツッコミポイント」のログです。</p>
                </div>
            </div>
        </header>
        ...
        <div class="flex-1 overflow-y-auto p-6 md:p-10">
            <div class="max-w-3xl mx-auto">
                <?php if (empty($rows)): ?>
                    ...
                    <p class="text-xs text-slate-400 mt-1">ダッシュボードの「今日の好奇心ブースト」「AI関連」「パレオな男」からトレーニングを始めてみましょう。</p>
                <?php else: ?>
                    <ul class="space-y-3">
